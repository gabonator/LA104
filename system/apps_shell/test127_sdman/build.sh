...
#arm-none-eabi-gcc -Wall -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float  -Wno-psabi -DLA104 -MD -I ../ -I ../../../os_host/source/ -c ../source/tjpgd.c -I../../../os_library/include/ 

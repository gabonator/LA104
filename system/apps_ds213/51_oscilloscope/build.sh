...
arm-none-eabi-g++ -Wall -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float -fno-exceptions -fno-rtti -fno-threadsafe-statics -Wno-psabi -DDS203 -MD -c \
-DSTM32F10X_HD \
../app/Main.cpp \
../app/Menu.c \
../app/Draw.c \
...
../../../../tools/elfstrip/elfstrip output.elf 51osc.elf

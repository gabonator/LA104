...
*/
// implementation
char* CDS213::DfuVersion()
{
  return (char*)Hw.pDfuVerStr;
}

char* CDS213::HardwareVersion()
{
  return (char*)Hw.pHwVerStr;
}

char* CDS213::SystemVersion()
{
  return (char*)Hw.pProductStr;
}

char* CDS213::FpgaVersion()
{
  return (char*)Hw.pFpgaTypStr;
}

char* CDS213::SerialNumber()
{                            
  static char serial[16];
  sprintf(serial, "%08x", Hw.ProductSN);
  return serial;
}

char* CDS213::DisplayType()
{
  return (char*)Hw.pLcdcTypStr;
}

char* CDS213::DiskType()
{
  return (char*)Hw.pDiskTypStr;
}

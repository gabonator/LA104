...
arm-none-eabi-gcc -fPIC -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../arduino/app.lds ./main.o ./Arduino.o ./SparkFun_APDS9960.o ./code.o -lbios -L../../../os_library/build -lm

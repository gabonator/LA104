...
arm-none-eabi-gcc -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float -Wno-psabi -DLA104 -MD -D _ARM -D STM32F10X_HD -c \
  ../source/esp-serial-flasher/slip.c \
  ../source/esp-serial-flasher/protocol.c \
  ../source/esp-serial-flasher/esp_targets.c \
  ../source/esp-serial-flasher/esp_loader.c
...
arm-none-eabi-gcc -fPIC -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../source/app.lds \
  ./main.o ./Wnd.o ./Serialize.o ./slip.o ./protocol.o ./esp_targets.o ./esp_loader.o \
...
../../../../tools/elfstrip/elfstrip output.elf 135espf.elf

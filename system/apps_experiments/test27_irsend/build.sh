...
arm-none-eabi-gcc -fPIC -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../app.lds ./main.o ./ir_tx.o ./system_stm32f10x.o ./stm32f10x_gpio.o ./stm32f10x_rcc.o ./stm32f10x_tim.o ./misc.o -lbios -L../../../os_library/build -lm #-lc -lm

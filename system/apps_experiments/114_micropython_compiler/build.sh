...
arm-none-eabi-gcc -g  -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float -fno-exceptions -Wno-psabi -DLA104 -MD -c \
../source/py/mpstate.c \
../source/py/nlr.c \
../source/py/nlrx86.c \
../source/py/nlrx64.c \
...
../../../../tools/elfstrip/elfstrip output.elf 114pycom.elf

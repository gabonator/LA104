...
arm-none-eabi-gcc -fPIC -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../app.lds ./main.o ./stm32f10x_i2c.o ./stm32f10x_gpio.o ./stm32f10x_rcc.o -lbios -L../../../os_library/build -lm #-lc -lm

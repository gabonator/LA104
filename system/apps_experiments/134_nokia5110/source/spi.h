...
//        Gpio::SetState(Gpio::BASEB, Gpio::P2RST, Gpio::StateInput | Gpio::StateInputFloating);
        Gpio::SetState(Gpio::BASEB, Gpio::P2RST, Gpio::StateOutput10Mhz | Gpio::StateOutputPushPull);
        Gpio::SetState(Gpio::BASEB, Gpio::P3SCK2, Gpio::StateOutput10Mhz | Gpio::StateOutputFunctionPushPull);
        Gpio::SetState(Gpio::BASEB, Gpio::P4DC, Gpio::StateOutput10Mhz | Gpio::StateOutputPushPull);
...
#define SPI_Direction_1Line_Tx          ((uint16_t)0xC000)
  ...
  uint32_t SPI_Direction = SPI_Direction_1Line_Tx; //SPI_Direction_2Lines_FullDuplex
  ...
  uint32_t SPI_BaudRatePrescaler = 0x0000; //0x0030; // SPI_BaudRatePrescaler_128
  ...
  SPI2->CR1 = tmpreg;
    ...
    void end() const
    {
        ...
        Gpio::SetState(Gpio::BASEB, Gpio::P2RST, Gpio::StateInput);
        Gpio::SetState(Gpio::BASEB, Gpio::P3SCK2, Gpio::StateInput);
        Gpio::SetState(Gpio::BASEB, Gpio::P4DC, Gpio::StateInput);
    }

    void transfer(uint8_t* bufWrite, int len) const
    {
...
//            d = SPI2->DR; // TODO?
    ...
    void transfer(uint8_t b) const
    {
        transfer(&b, 1);
    }

    void reset(bool high) const
    {
        Gpio::SetLevel(Gpio::BASEB, Gpio::P2RST, high);
    }

    void dataCommand(bool high) const
    {
        Gpio::SetLevel(Gpio::BASEB, Gpio::P4DC, high);
    }
};

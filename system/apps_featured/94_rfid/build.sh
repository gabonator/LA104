...
arm-none-eabi-g++ -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float -fno-exceptions -fno-rtti -fno-threadsafe-statics -Wno-psabi -fno-use-cxa-atexit -DLA104 -MD -D _ARM -D STM32F10X_HD -c \
  ../source/main.cpp \
  ../source/mfrc522/MFRC522.cpp \
  ../source/mfrc522/MFRC522_spi.cpp \
  ../source/mfrc522/platform.cpp \
...
arm-none-eabi-gcc -fPIC -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../source/app.lds \
  ./main.o ./MFRC522.o ./MFRC522_spi.o ./platform.o ./Wnd.o ./Serialize.o -lbios_la104 -L../../../os_library/build

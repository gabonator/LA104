namespace Layout
{
    ...
    class HLine : public Sublayout
    {
        uint32_t mColor;
    public:
        HLine(int32_t color) : mColor(color)
        {
        }
        ...
        virtual void Visit(Render* r) const
        {
            ...
            //rcElement.Deflate(4, 0, 4, 0);
            rcElement.bottom = rcElement.top+1;
            LCD::Bar(rcElement, mColor);
            
            CRect& r1 = (CRect&)r->GetRectangle();
            r1.top += 2;
        }
    };

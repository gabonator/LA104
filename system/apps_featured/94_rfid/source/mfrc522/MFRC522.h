...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_Authenticate(byte command, byte blockAddr, const MIFARE_Key *key, Uid *uid);
	...
	void PCD_DumpVersionToSerial(char* ver);
...
public:
	virtual bool PCD_Init() = 0;
        virtual void PCD_WriteRegister(MFRC522::PCD_Register reg, byte value) = 0;
        virtual void PCD_WriteRegister(MFRC522::PCD_Register reg, byte count, byte *values) = 0;
        virtual byte PCD_ReadRegister(MFRC522::PCD_Register reg) = 0;
        virtual void PCD_ReadRegister(MFRC522::PCD_Register reg, byte count, byte *values, byte rxAlign = 0) = 0;
};
...
public:
        MFRC522_I2C(byte resetPowerDownPin = UNUSED_PIN,
                byte chipAddress = MFRC522_I2C_DEFAULT_ADDR)
                : _resetPowerDownPin(resetPowerDownPin),  _chipAddress(chipAddress) {};
	bool PCD_Init();
        void PCD_WriteRegister(MFRC522::PCD_Register reg, byte value);
        void PCD_WriteRegister(MFRC522::PCD_Register reg, byte count, byte *values);
        byte PCD_ReadRegister(MFRC522::PCD_Register reg);

...
1150 GOTO 1110
1160 REM DEF SEG=0
1170 GOTO 1420: REM IF (PEEK(&H410) AND &H30)<>&H30 THEN DEF SEG:GOTO 1291
...
1294 GOTO 1300
1295 COLOR 31,0,0
1296 PRINT "THIS PROGRAM REQUIRES ADVANCED BASIC -- USE COMMAND 'BASICA'":COLOR 15,0,0
1297 FOR I=1 TO 9000:NEXT I: REM RESUME 1298
1298
1299 IF SAMPLES$="YES" THEN CHAIN"samples",1000 :ELSE COLOR 7,0,0:CLS:END
1300 REM
1410 PLAY "mfl32t067"
1420 DIM B(280): DIM A(150)
1430 CLS:COLOR 8,0
1440 CIRCLE (160,100),10,2
1450 PAINT (160,100),2,2
1460 REM GET (150,90)-(170,110),A

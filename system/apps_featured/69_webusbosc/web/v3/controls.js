...
.blockControl { border: 2px solid #b0b0b0; }
</style>
...
<!--
  ...
  <div class="controlsBlock blockControl">
    Control:<br><br>
    <select id="controlAttribute">
      <option value="0">CH_A_OFFSET</option>
      <option value="1">CH_B_OFFSET</option>
      <option value="2">BACKLIGHT</option>
      <option value="3">BEEP_VOLUME</option>
      <option value="4">BETTERY_DT</option>
      <option value="5">ADC_MODE</option>
      <option value="6">FIFO_CLR</option>
      <option value="1">W_PTR</option>
      <option value="7">T_BASE_PSC</option>
      <option value="8">T_BASE_ARR</option>
      <option value="9">CH_A_COUPLE</option>
      <option value="10">CH_A_RANGE</option>
      <option value="11">CH_B_COUPLE</option>
      <option value="12">CH_B_RANGE</option>
      <option value="13">ANALOG_ARR</option>
      <option value="14">ANALOG_PTR</option>
      <option value="15">ANALOG_CNT</option>
      <option value="16">DIGTAL_PSC</option>
      <option value="17">DIGTAL_ARR</option>
      <option value="18">DIGTAL_CCR</option>
      <option value="19">KEY_IF_RST</option>
      <option value="20">STANDBY</option>
      <option value="31">FPGA_RST</option>
      <option value="32">TRIGG_MODE</option>
      <option value="33">V_THRESHOLD</option>
      <option value="34">T_THRESHOLD</option>
      <option value="36">ADC_CTRL</option>
      <option value="37">A_POSITION</option>
      <option value="38">B_POSITION</option>
      <option value="39">REG_ADDR</option>
      <option value="1024">FPGA_SP_TRIGGMODE</option>
      <option value="1025">FPGA_SP_VTHRESHOLD</option>
      <option value="1026">FPGA_SP_TTHRESHOLD_L</option>
      <option value="1027">FPGA_SP_TTHRESHOLD_H</option>
      <option value="1028">FPGA_SP_CTRLREG</option>
      <option value="1029">FPGA_SP_SELECT</option>
      <option value="1030">FPGA_SP_DEPTH_L</option>
      <option value="1031">FPGA_SP_DEPTH_H</option>
      <option value="1032">FPGA_SP_PERCNT_L</option>
      <option value="1033">FPGA_SP_PERCNT_H</option>
      <option value="1034">FPGA_SP_DELAY_1</option>
      <option value="1035">FPGA_SP_DELAY_2</option>
      <option value="1036">FPGA_SP_DELAY_3</option>
      <option value="1037">FPGA_SP_DELAY_4</option>
    </select><br>
    Value:<input size=8 type="text" value="0" id="controlValue"><br>
  </div>
-->
...
//      (o) => INTERFACE.memoryExport());
  ...
  memPreview(rawdata)
  {
    ...
    var data1 = [], data2 = [];
    for (var i =0, x=0; i<rawdata.length && x < canvas.width; i+=3, x+=0.1)
    {
      data1.push({x:x, y:ypos(rawdata[i])});
      data2.push({x:x, y:ypos(rawdata[i+1])});
    }

...
uintptr_t GetProcAddress(char* symbol)
{
  uint32_t hash = 5381;
  uint8_t c;
  while ((c = *symbol++) != 0)
  ...
  switch (hash & 0x0000ffff)
  {
    ...
    case 0x00005ce6: return (uint32_t)static_cast<uintptr_t(*)(char*)>(BIOS::SYS::GetProcAddress); //_ZN4BIOS3SYS14GetProcAddressEPc

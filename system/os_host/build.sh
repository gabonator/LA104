...
arm-none-eabi-g++ -Wall -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float -MD -fno-exceptions -fno-rtti -fno-threadsafe-statics -Wno-psabi -c -Wall -Werror -D USE_STDPERIPH_DRIVER -D STM32F10X_HD ${INCLUDES} -c ../main.cpp ../source/Manager.cpp ../source/framework/Wnd.cpp ../source/bios/sys.cpp ../source/bios/lcd.cpp ../source/bios/memory.cpp ../source/bios/fat.cpp ../source/bios/key.cpp ../source/bios/os.cpp ../source/framework/Utils.cpp ../source/bios/dbg.cpp ../source/bios/gpio.cpp ../source/library/spf.c ../source/Execute.cpp ../source/Framework/Serialize.cpp ../source/gui/Gui.cpp
arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../app.ld ./main.o ./startup.o ./interrupt.o ./sys.o ./Wnd.o ./lcd.o ./memory.o ./fat.o ./key.o ./Utils.o ./dbg.o ./os.o ./spf.o ./Execute.o ./Serialize.o ./imports.o ./stm32f10x_flash.o ./stm32f10x_spi.o ./stm32f10x_rcc.o ./Manager.o ./usb_init.o ./USB_scsi.o ./Disk.o ./USB_bot.o ./usb_mem.o ./usb_regs.o ./system_stm32f10x.o ./USB_prop.o ./usb_core.o ./usb_int.o ./USB_istr.o ./USB_desc.o ./USB_pwr.o ./Ext_Flash.o ./Gui.o ./stm32f10x_gpio.o ./stm32f10x_tim.o ./gpio.o ./stm32f10x_i2c.o ./stm32f10x_usart.o ./misc.o

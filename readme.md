...
How to install:
  ...
  - When the firmware is run for the first time, it will ask for "shell.elf", copy all the elf files from [69_webusbosc/release](system/apps_ds213/69_webusbosc/release) to your device, and turn off/on

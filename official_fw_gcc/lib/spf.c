...
static void sfp_printchar(char **str, int c)
{
...
static int sfp_prints(char **out, const char *string, int width, int pad)
{
...
static int sfp_printf(char **out, float f, int width)
{
...
static int sfp_printi(char **out, int i, int b, int sg, int width, int pad, int letbase)
{
	char print_buf[PRINT_BUF_LEN];
	register char *s;
...
static int sfp_print(char **out, const char *format, va_list args )
{
